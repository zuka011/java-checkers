...
public class FacePamphletProfile implements FacePamphletConstants, Comparator<String> {
 ...
 */
	public boolean addFriend(String friend) {
		Collections.sort(friendsList, this);
 ...
 */ 
	public String toString() {
		return profileName + " (" + profileStatus + "): " + friendList();
	}
	
/*
 * 	Returns the string of friends list separated by comma
 */
	private String friendList() {
		String result = "";
		Iterator<String> iterator = getFriends();
